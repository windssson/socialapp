...
class Constant {
  ...
  TextStyle profilbaslik = GoogleFonts.quicksand(
      fontSize: 22, color: Colors.white, fontWeight: FontWeight.w600);
  TextStyle biobaslik = GoogleFonts.quicksand(
      fontSize: 18, color: Colors.black, fontWeight: FontWeight.w600);
  TextStyle flowbaslik = GoogleFonts.quicksand(
      fontSize: 18, color: Colors.black, fontWeight: FontWeight.bold);
  TextStyle flowtext = GoogleFonts.quicksand(
